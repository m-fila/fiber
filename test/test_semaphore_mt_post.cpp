...
void wait_fn( boost::fibers::semaphore & l) {
    l.wait();
    ++value;
}

void count_down_fn( boost::fibers::semaphore & l) {
    l.count_down();
}

void arrive_and_wait_fn( boost::fibers::semaphore & l) {
    l.arrive_and_wait();
    ++value;
}
...
boost::unit_test::test_suite * init_unit_test_suite( int, char* []) {
    boost::unit_test::test_suite * test =
        BOOST_TEST_SUITE(
            "Boost.Fiber: multithreaded semaphore test suite");
